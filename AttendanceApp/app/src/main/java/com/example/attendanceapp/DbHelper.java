...
public class DbHelper<addClass> extends SQLiteOpenHelper {
    ...
    private static final String CREATE_CLASS_TABLE =
            "CREATE TABLE " + CLASS_TABLE_NAME + "(" + C_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " +
    ...
    private static final String CREATE_STUDENT_TABLE =
            " CREATE TABLE " + STUDENT_TABLE_NAME + "( " + S_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " +
                    C_ID + " INTEGER NOT NULL, " + STUDENT_NAME_KEY + " TEXT NOT NULL, " +
    ...
    private static final String CREATE_STATUS_TABLE =
            " CREATE TABLE " + STATUS_TABLE_NAME + "( " + STATUS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " +
                    S_ID + " INTEGER NOT NULL, "+ C_ID + " INTEGER NOT NULL, " + DATE_KEY + " DATE NOT NULL, " +
 ...
 int deleteClass(long cid){
    ...
    //add student option in the top right dropbox
    ...
    //adds if a student if he's absent or not
    ...
    //updates the value of student to absent/present
    ...
    //shows if the student is present or not
